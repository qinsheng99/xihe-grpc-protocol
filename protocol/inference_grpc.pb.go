...
type InferenceClient interface {
	SetInferenceInfo(ctx context.Context, in *InferenceInfo, opts ...grpc.CallOption) (*InferenceResult, error)
}
...
func (c *inferenceClient) SetInferenceInfo(ctx context.Context, in *InferenceInfo, opts ...grpc.CallOption) (*InferenceResult, error) {
	out := new(InferenceResult)
	err := c.cc.Invoke(ctx, "/inference.Inference/SetInferenceInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InferenceServer interface {
	SetInferenceInfo(context.Context, *InferenceInfo) (*InferenceResult, error)
...
func (UnimplementedInferenceServer) SetInferenceInfo(context.Context, *InferenceInfo) (*InferenceResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetInferenceInfo not implemented")
}
...
func _Inference_SetInferenceInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InferenceInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServer).SetInferenceInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.Inference/SetInferenceInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServer).SetInferenceInfo(ctx, req.(*InferenceInfo))
	}
...
var Inference_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetInferenceInfo",
			Handler:    _Inference_SetInferenceInfo_Handler,
		},
	},
